...
function RadialBarChartScore({ score }) {
    ...
    return (
        <ContainerRadialBarCharts>
            <RadialBarChart width={300} height={300} cx={150} cy={150} innerRadius={100} outerRadius={87} barSize={20} data={data} startAngle={startAngleDegrees} endAngle={endAngle} fill={"#FF0101"}>
